gameGetObjects = function(asset) local id = tonumber(asset:match("%d+")) return game:GetService('InsertService'):LoadAsset(id):GetChildren() end
local topkek = {}
topkek.patch = '1.0.5a'
topkek.data = {}
topkek.commandbase = {}
...
topkek.misc = {}
if game.Players.LocalPlayer.PlayerGui:FindFirstChild("4.0") then
	game.Players.LocalPlayer.PlayerGui["4.0"]:Remove()
end
...
NewGuiPart15.Text = "Server Message: ALLAH AKBAR"
...
NewGuiPart16.Text = "Type ; To use a command :)"
...
topkek.navigation.buildHomePage = function()
	...
	hook:drawText(1, 'T0PK3K 4.0 ex-7 edition by FancyKid')
...
lpwin:drawButton(1/2, 'Fedora', function()
	...
	gameGetObjects("rbxassetid://" .. tostring(hats[math.random(1,#hats)]))[1].Parent = topkek.lplr.Character
end)
...
--scriptwin:addSpacing()
--local scripts = gameGetObjects("rbxassetid://376553985")[1]
--local container = {}
...
--	gameGetObjects('rbxassetid://'..tostring(v['AssetId']))[1].Parent = Model
--	Model:MakeJoints()
...
local faces = {	
	...
	{name='troll face',id=79805401443240},
	{name='Pepe',id=74858178981752},
	{name='Jeff',id=109129888},
	{name='Rain',id=574772793},
	{name='Yeaw',id=53646377},
	{name='Here',id=62677045},
	{name='Har',id=48260066},
	{name='Baby Sun',id=47596170},
	{name='LOL',id=48293007},
	{name='idk',id=53645378},
...
hatwin:drawButton(1/3, 'Wear', function()
	local hat = gameGetObjects("rbxassetid://"..tonumber(hatInp.Text))[1]
